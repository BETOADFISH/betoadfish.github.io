...
export default function MCR() {
 ...
 <SiteLink href="https://www.nature.com/articles/srep39392" target="_blank" rel="noreferrer"><Copy>{t('Background: structural study of MCR-1 (2016) ↗','研究背景：MCR-1 结构研究（2016）↗')}</Copy></SiteLink></details></CaseShell>;
}
