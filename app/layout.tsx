...
const appearanceScript = `(function(){try{var t=localStorage.getItem('bill-theme');document.documentElement.dataset.theme=t==='dark'||(t!=='light'&&matchMedia('(prefers-color-scheme: dark)').matches)?'dark':'light';document.documentElement.lang=location.pathname.split('/')[1]==='zh'?'zh-CN':'en';if(location.pathname==='/'&&localStorage.getItem('bill-language')==='zh'){location.replace('/zh'+location.search+location.hash)}}catch(e){}})()`;
